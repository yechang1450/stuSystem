...
CREATE TABLE `weixin_user` (
  ...
  `current_unit` varchar(40) DEFAULT NULL COMMENT '所在单位',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=356 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='微信用户表';

-- ----------------------------
-- Records of weixin_user
-- ----------------------------
INSERT INTO `weixin_user` VALUES ('350', '王震', '1', 'zh_CN', 'Haidian', 'Beijing', 'https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTI8pva61qjyt4hjuqzr68jAH1ht2OjGHDOQjI72FqdNPZSSwAO5dB6Z0E3mJqqUpYicWSbzGiar4afw/132', 'oqJrq5nplPBhm3BwJ74GmIrZLXgY', '2019-04-02 20:22:55', '2019-04-10 20:27:00', 'dcdfvfdb', null, null);
INSERT INTO `weixin_user` VALUES ('355', '张燕', '2', 'zh_CN', 'Baoding', 'Hebei', 'https://wx.qlogo.cn/mmopen/vi_32/NpC4KLpNOrKic7yQVDUF3ev4VmavhkNkXWPuwCdxwCTcLuj6MU2vw4F5baP62bCSvDLEBjicVFJnGa6Hy2j7oYIQ/132', 'o2lpd1K-o_AKHmk_lQkBkGuip1Ao', '2019-04-12 14:07:26', '2019-04-12 14:42:34', 'zhangyan', '15830076844', 'vdfbfgb');
